...
| **PUT** to **localhost:8080/project/#** to update project where # equals id of desired project, request body as json must be as follows: **nameEn** - Name of the project in english. **descEn** - Description of the project in english. **keywords** - Keywords specific to this project.
